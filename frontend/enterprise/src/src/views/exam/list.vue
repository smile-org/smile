      ...
      <section class="con_main_r">
        ...
        <div class="con_tab">
          ...
          <el-table  :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="examCount" label="次数限制" width="180">
            </el-table-column>
            <el-table-column prop="examScore" label="通过分数" width="180">
            </el-table-column>
            <el-table-column prop="examTime" label="时间限制" width="180">
            </el-table-column>
