<template>
  <div>
    <search-header v-bind:holder="searchPlaceHolder" type=4></search-header>
    <section>
      <ul class=" list_border course_line reg_nohover mb3hafe" v-infinite-scroll="loadMore"
    ...
    <!--<footer>-->
    <!--</footer>-->
    <img src="../../assets/img/add_booking.png" v-on:click="newBooking"  class="add_booking"/>
